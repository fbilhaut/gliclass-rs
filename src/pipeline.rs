...
use orp::pipeline::{Pipeline, PostProcessor, PreProcessor};
use std::path::Path;
...
impl<'a> Pipeline<'a> for ClassificationPipeline {
    ...
    fn post_processor(
        ...
        composable::composed![super::output::tensors::OutputTensors::try_from, |tensors| {
            super::output::classes::Classes::try_from(tensors)
        }]
    }
}
